...
export default function ProductCard({
  ...
  // Bug #1: Broken Add Button - Second card's button does nothing
  ...
  // Bug #6: Wrong Currency - Fourth card shows NaN price
  const bug6Active = isBugActive(6) && cardIndex === 3;

  const handleAddToCart = () => {
    if (bug1Active) {
      // Bug #1: Button does nothing
      return;
    }
    onAddToCart(product);
  };
